 ...
 */
class Role extends \App\Domain\Entities\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Entities\\Role' . "\0" . 'entity', '' . "\0" . 'App\\Domain\\Entities\\Role' . "\0" . 'party', 'roleType', 'fromDate', 'thruDate'];
        }
