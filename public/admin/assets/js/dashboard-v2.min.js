...
var handleScheduleCalendar = function() {
    ...
    var n = new Date(),
        ...
        i = n.getFullYear();
    var s = [
        [ d+"/" + r + "/" + i, "Popover Title", "#", "#00acac", "Some contents here"],
        ["10/" + r + "/" + i, "Tooltip with link", "http://www.seantheme.com/color-admin-v1.3", "#2d353c"],
...
//Notificaciones cargar cn ajax despues de cargar la pagina
